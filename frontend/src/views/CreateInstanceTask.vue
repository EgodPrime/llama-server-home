  ...
  <div class="create-task-page">
    ...
    <form @submit.prevent="handleSubmit">
      ...
      <div class="form-row">
        ...
        <div class="hint">可填项参考：--n-gpu-layers, --ctx-size, --parallel, --batch-size, --n-predict, --temp, --top-k, --top-p, --min-p, --presence_penalty, --frequency-penalty, --repeat-penalty, --threads, --flash-attn, --split-mode, --tensor-split</div>
      </div>
      <div class="form-row">
...
const form = ref<CreateInstanceTask>({
  type: 'DEPLOY',
  instance_name: '',
  node_id: '',
  port: 8001,
...
const result = ref<{ message: string; task_id: string } | null>(null);
...
async function handleSubmit() {
  updateEnvObj();
  updateConfigObj();
  result.value = await createInstanceTask(form.value);
}
</script>
...
/* 整体页面美化 */
  ...
  input:focus, select:focus, textarea:focus {
    border-color: #1979C6;
    box-shadow: 0 2px 8px rgba(25,121,198,0.10);
  }
  textarea {
    min-height: 48px;
  }
